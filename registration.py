    ...
    def has_cycle(self):
        ...
        for vertex in range(len(self.vertices)):
            if not visited_nodes[vertex]:
                if dfs(vertex, visited_nodes, recursive_stack):
                    return True
        ...
        while temp_vertices:
            ...
            for index in sorted(no_prereqs, reverse=True):
                if len(now_semester) < 4:
                    ...
                    delete_vertex_from_copy(temp_vertices[index].label, temp_matrix, temp_vertices)
...
def main():
    ...
    for i in range(num_edges):
        ...
        graph.add_edge(graph.get_index(beginning), graph.get_index(end))
